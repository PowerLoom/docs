...
Snapshotter (Full Node) has a complicated architecture with multiple moving parts. The easiest way to get started is by using the Docker-based setup, recommended for most users.
